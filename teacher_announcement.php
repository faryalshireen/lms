            ...
            <div class="container">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-12 grid-margin stretch-card pl-5 pr-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title text-primary pb-4 pt-2">Admin Announcements</h4>
                                <?php
                                $c = 1;
                                require 'db3.php';
                                // $t_id = $_SESSION['id'];
                                ...
                                if (isset($_GET['id'])) {
                                    $c_id = $_GET['id'];
                                    $select = "SELECT * FROM `announcements` WHERE course_id= '{$c_id}' AND role_id=1 AND assign_id=2 AND date >= '{$p_current_date}'";
                                } else {
                                    $select = "SELECT * FROM `announcements` WHERE role_id=1 AND assign_id=2 AND date >= '{$p_current_date}'";
                                }
                                    ...
                                    <form onsubmit="return false" method="POST">
                                        <div class="announcement__main_card" style="width: 100%;">
                                            ...
                                            <div class="text-center" style="width: 20%;">
                                                <button type="button" onclick="formsubmit(<?php echo $result['id'] ?>)" class="btn btn-link btn-sm font-weight-bold" data-toggle="collapse" data-target="#collapse<?php echo $result['id'] ?>">View Announcement</button>
                                            </div>
                                        </div>
                                ...
                                if (isset($_GET['id'])) {
                                    $c_id = $_GET['id'];
                                    $f_select = "SELECT * FROM `announcements` WHERE course_id= '{$c_id}' AND role_id=2 AND assign_id=3 AND date >= '{$pag_current_date}'";
                                } else {
