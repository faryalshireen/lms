...
<body>
  <div class="container mt-4">
    <h4 class="text-primary pt-3 pb-2 pl-2">Submitted Assignments</h4>
    <div class="row">
          ...
          <div class="text-center align-center">
            <table class="table">
              ...
              <tbody>
                ...
                AND assignments.teacher_id= '{$_SESSION['id']}' WHERE userdata.Semester='{$semester_row['Semester']}' AND userdata.section='{$t_get_row['section']}' ORDER BY userdata.user_id";
                ...
                ?>
                  <tr>
                    ...
                    <form action="submit_assignments.php" method="POST" enctype="multipart/form-data">
                      <td>
                      ...
                      <td>
                        ...
                        ?>
                          <button type="submit" formaction="submit_assignments.php?id=<?php echo $_GET['id'] ?>" data-toggle="tooltip" title="Fail Student" class="btn btn-danger btn-sm" name="std_marks_status" value="Fail" style="padding: 5px 10px;"><i class="fas fa-times"></i></button>
                          <button type="submit" formaction="submit_assignments.php?id=<?php echo $_GET['id'] ?>" data-toggle="tooltip" title="Pass Student" class="btn btn-success btn-sm" name="std_marks_status" value="Pass" style="padding: 5px 10px;"><i class="fas fa-check"></i></button>
                        <?php
                        }
                        ?>
                      </td>
