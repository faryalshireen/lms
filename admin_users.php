...
<body>
  ...
  <div class="container mb-4">
    <div class="row pl-3 pr-3 mb-3">
      <div class="col-md-12 card p-3">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item">
            <a class="nav-link active" id="all_admins_tab" href="admin_users.php">Admins</a>
          </li>
        </ul>
              ...
              <div class="container">
                <tr>
                  ...
                  <td style="display: inline-flex;">
                    ...
                    <?php
                    if ($status == 1) {
                      echo '<form action="admin_users.php?block=' . $row['id'] . '" method="POST">
                          <button class="btn btn-primary btn-sm" type="submit" name="block">Block</button>
                          </form>';
                    } else {
                      echo '<form action="admin_users.php?unblock=' . $row['id'] . '" method="POST">
    ...
    <a href="export_to_excel.php?id=1" class="btn btn-warning btn-sm pl-3 pr-3">Export Excel</a>
  </div>
