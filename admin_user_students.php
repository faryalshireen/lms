...
if (isset($_POST['snoEdit'])) {
    ...
    $edit_usection = $_POST['user_sectionId'];
    ...
    if ($u_password == $u_confirmPassword) {
        ...
        $result = mysqli_query($conn, $sql);
        if ($result) {
            $userdata_sql = "UPDATE `userdata` SET `section` = '$edit_usection'  WHERE `userdata`.`user_id` = $editno";
            mysqli_query($conn, $userdata_sql);
...
<body>
  ...
  Launch demo modal
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="admin_user_students.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="user_sectionId" id="user_sectionId">
    ...
    <div class="container mb-12">
        <div class="row pl-3 pr-3 mb-3 col-12">
            <div class="col-md-12 card p-3 col-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="all_students_tab" href="admin_user_students.php">Students</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="all_teachers_tab" href="admin_user_teachers.php">Teachers</a>
                    </li>
                    <li class="nav-item">
                            ...
                            <div class="container">
                                <tr>
                                    ...
                                    <td style="display: inline-flex;">
                                        ...
                                        <?php
                                        if ($status == 1) {
                                            echo '<form action="admin_user_students.php?block=' . $row['id'] . '" method="POST">
                                            <button class="btn btn-primary btn-sm" type="submit" name="block">Block</button>
                                            </form>';
                                        } else {
                                            echo '<form action="admin_user_students.php?unblock=' . $row['id'] . '" method="POST">
        ...
        <a href="export_to_excel.php?id=3" class="btn btn-warning btn-sm pl-3 pr-3">Export Excel</a>
    </div>
    ...
    <script>
        ...
        Array.from(edits).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                sectionId = tr.getElementsByTagName("td")[5].innerText;
                ...
                user_sectionId.value = sectionId;
        ...
        Array.from(deletes).forEach((element) => {
            element.addEventListener("click", (e) => {
                ...
                if (confirm("Are you sure you want to delete this User?")) {
                    console.log("yes");
                    window.location = `admin_user_students.php?Delete=${id}`;
                } else {
                    console.log("no");
                }
